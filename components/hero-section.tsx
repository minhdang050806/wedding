  ...
  return (
    <section className="relative w-full min-h-[80vh] md:min-h-screen flex items-center justify-center bg-romantic-gradient">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto animate-fade-in py-16 md:py-24">
        ...
        {/* Names */}
        <h1
          className="font-script text-shimmer animate-glow tracking-wide whitespace-nowrap mb-1 md:mb-2"
        ...
        <div className="flex items-center justify-center gap-4 my-2 md:my-6">
          ...
          <span
            className="font-script text-primary/70"
        ...
        <h2
          className="font-script text-shimmer animate-glow tracking-wide whitespace-nowrap mb-4 md:mb-10"
        ...
        {/* Tagline */}
        <p
          className="font-display text-sm md:text-3xl text-foreground/70 mb-5 md:mb-12 max-w-2xl mx-auto font-light tracking-wide"
        >
        ...
        <div className="wing-hover inline-block mb-4 md:mb-10">
          <div className="bg-card rounded-2xl px-4 md:px-8 py-4 md:py-8 border border-border shadow-md">
            <p className="font-luxe text-foreground/50 text-[12px] md:text-xs mb-3 md:mb-6">
                ...
                <div key={index} className="flex items-start">
                  <div className="text-center group flex flex-col items-center min-w-[2.5rem] md:min-w-[4.5rem]">
                    <div className="bg-secondary/60 rounded-lg px-2 py-1 md:px-3 md:py-2 mb-1 md:mb-2 w-full">
                      <div
                        className="font-display text-2xl md:text-5xl text-foreground font-light transition-transform duration-300 group-hover:scale-110 tabular-nums"
                      >
                        {String(item.value).padStart(2, '0')}
                      </div>
                    </div>
                    <div className="font-luxe text-[13px] md:text-[13px] text-foreground/50">
                      {item.label}
                    </div>
                  </div>
                  {index < units.length - 1 && (
                    <div
                      className="text-foreground/50 text-lg md:text-3xl font-light px-1 md:px-2 mt-1 md:mt-1 select-none"
                      aria-hidden="true"
                    >
                      :
                    </div>
        ...
        <div className="animate-bounce flex justify-center mt-2 md:mt-4">
          <svg className="w-5 h-5 md:w-6 md:h-6 text-foreground/40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
