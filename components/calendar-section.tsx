...
export function CalendarSection() {
  return (
    <section className="relative w-full py-12 md:py-14 lg:py-16 px-4 bg-romantic-gradient overflow-hidden lg:min-h-screen lg:flex lg:flex-col lg:justify-center">
